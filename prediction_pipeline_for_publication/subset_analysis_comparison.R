...
n_sim <- 100 # number of random link withholding and prediction iterations. Here we increased it to 100 since the matrices are smaller when only shared species are considered
