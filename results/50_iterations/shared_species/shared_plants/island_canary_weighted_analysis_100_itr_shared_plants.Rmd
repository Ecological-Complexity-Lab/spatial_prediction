---
title: "softimpute analysis pipeline - island scale (100 iterations) - only shared plants"
...
df <- read_csv('weighted__scaled_island_net_60_100_itr_shared_plants.csv') # weighted, scaled
