...
prop_ones_to_remove <- 1.0 # proportion of existing links to withhold
...
saveRDS(combined_results,
        file = paste0("prediction_pipeline_for_publication/results/predictions_island_scale_all_nas.rds"))
combined_results <- 
        readRDS(file = paste0("prediction_pipeline_for_publication/results/predictions_island_scale_all_nas.rds"))
...
# pdf(
#   file   = "map_missing_links_all_nas.pdf",
#   width  = 11,    # inches
#   height = 6,
#   family = "Helvetica"   # or another installed font
# )
